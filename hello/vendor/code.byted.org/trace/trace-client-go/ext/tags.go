...
var (
	...
	// TraceClientVersion is the version of the client library reported as Span tag.
	TraceClientVersion = "Go-1.3.4"

	// TraceClientVersionTagKey is the name of the tag used to report client version.
	TraceClientVersionTagKey = "client.version"

	// TraceClientVersionTagKey is the name of the tag used to report client version.
	TraceClientVersionTag = opentracing.Tag{Key: TraceClientVersionTagKey, Value: TraceClientVersion}
	...
	ErrorCode = int32TagName("errCode")
	ErrorType = int32TagName("errType")

	StressTag = stringTagName("stressTag")
	HTTPHost  = stringTagName("http.host")
	HTTPParam = stringTagName("http.params")

	HTTPHeaderTTStable      = int32TagName("http.header.tt_stable")
	HTTPHeaderBdTtErrorCode = int32TagName("http.header.bd-tt-error-code")
