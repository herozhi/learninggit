...
type Metrics struct {
	// Number of spans not started due to ratelimit
	RateLimitedSpans metrics.Counter `metric:"ratelimited_spans"`

	// Number of post spans ratelimited
	DownstreamRateLimitedPostSpans metrics.Counter `metric:"ratelimited_post_spans" tags:"limiter=downstream"`

	// Number of post spans ratelimited
	GlobalRateLimitedPostSpans metrics.Counter `metric:"ratelimited_post_spans" tags:"limiter=global"`

	// Number of post traces started by this tracer
	PostTracesStarted metrics.Counter `metric:"post_traces"`

	// Number of post spans started by this tracer
	PostSpansStarted metrics.Counter `metric:"post_spans"`
	...
	// Number of times the CentralizedSampler succeeded to retrieve sampling strategy
	CentralizedSamplerRetrieved metrics.Counter `metric:"centralized_sampler_queries" tags:"result=ok"`

	// Number of times the CentralizedSampler failed to retrieve sampling strategy
	CentralizedSamplerQueryFailure metrics.Counter `metric:"centralized_sampler_queries" tags:"result=err"`

	// Number of times the CentralizedSampler succeeded to retrieve and update sampling strategy
	CentralizedSamplerUpdated metrics.Counter `metric:"centralized_sampler_updates" tags:"result=ok"`

	// Number of times the CentralizedSampler failed to update sampling strategy
	CentralizedSamplerUpdateFailure metrics.Counter `metric:"centralized_sampler_updates" tags:"result=err"`

	// Number of times the Sampler succeeded to retrieve dye app uuid conf
	DyeAppUUIDRetrieved metrics.Counter `metric:"dye_app_uuid_queries" tags:"result=ok"`

	// Number of times the Sampler failed to retrieve dye app uuid conf
	DyeAppUUIDQueryFailure metrics.Counter `metric:"dye_app_uuid_queries" tags:"result=err"`

	// Number of times the Sampler succeeded to retrieve and update dye app uuid conf
	DyeAppUUIDUpdated metrics.Counter `metric:"dye_app_uuid_updates" tags:"result=ok"`

	// Number of times the Sampler failed to update dye app uuid conf
	DyeAppUUIDUpdateFailure metrics.Counter `metric:"dye_app_uuid_updates" tags:"result=err"`
