...
// NewOriTBinaryProtocolFactoryDefault rename NewTBinaryProtocolFactoryDefault
func NewOriTBinaryProtocolFactoryDefault() *TBinaryProtocolFactory {
	return NewTBinaryProtocolFactory(false, true)
}

// NewTBinaryProtocolFactoryDefault only use for kite
func NewTBinaryProtocolFactoryDefault() *HeaderProtocolFactory {
	return NewHeaderProtocolFactory(ProtocolIDBinary)
}
...
func (p *TBinaryProtocol) readStringBody(size int) (value string, err error) {
	...
	buffer := GetIoBuffer(size)
	defer PutIoBuffer(buffer)
