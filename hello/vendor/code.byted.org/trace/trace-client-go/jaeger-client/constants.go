...
const (
	...
	// SamplerTypePostTrace is the type of sampler that samples
	// by post trace.
	SamplerTypePostTrace = "posttrace"
...
var (
	//PostTraceRootSpanTag is tag for root span in post-trace
	PostTraceRootSpanTag = opentracing.Tag{Key: "postTraceRoot", Value: true}

	//PostTraceTag indicates that the trace is a post-trace
	PostTraceTag = opentracing.Tag{Key: SamplerTypeTagKey, Value: SamplerTypePostTrace}

	//PostTraceFromDownstremTag indicates that post span is invoked by downstream.
	PostTraceFromDownstremTag = []Tag{{"pt.fd", true}}
)
