...
type rateLimiter struct {
	...
	maxBalance            float64
	lastTick              time.Time
	updateBalanceInterval time.Duration
...
// updateBalanceInterval determines how often the balance is updated
func NewRateLimiter(creditsPerSecond, maxBalance float64, updateBalanceInterval time.Duration) RateLimiter {
	return &rateLimiter{
...
func (b *rateLimiter) CheckCredit(itemCost float64) bool {
	...
	if elapsedTime >= b.updateBalanceInterval {
