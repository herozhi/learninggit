...
// NewOriTCompactProtocolFactory rename by NewTCompactProtocolFactory
func NewOriTCompactProtocolFactory() *TCompactProtocolFactory {
	return &TCompactProtocolFactory{}
}

// NewTCompactProtocolFactory only used by kite
func NewTCompactProtocolFactory() *HeaderProtocolFactory {
	return NewHeaderProtocolFactory(ProtocolIDCompact)
}
