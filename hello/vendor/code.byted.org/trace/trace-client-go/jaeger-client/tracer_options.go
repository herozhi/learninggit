...
func (tracerOptions) PostTraceIDGenerator(traceIDGenerator func(options opentracing.StartSpanOptions) TraceID) TracerOption {
	return func(tracer *Tracer) {
		tracer.options.postTraceIDGenerator = traceIDGenerator
	}
}
