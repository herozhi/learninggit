...
func (d MySQLDriver) Open(dsn string) (driver.Conn, error) {
	...
	var retryIndex = 0
	var connRetryMax = CONN_RETRY_UNLIMIT

	if cfg.ConnRetryCnt < CONN_RETRY_UNLIMIT && cfg.ConnRetryCnt != 0 {
		connRetryMax = cfg.ConnRetryCnt
	}
	for len(addrs) > 0 && retryIndex < connRetryMax {
		retryIndex++
